...
if (!isset($_POST['submit']))  {
  ...
  //echo "<pre>";print_r($_POST); exit;
    ...
    $sql1 = "INSERT INTO industry_case_studies (`industry_id`, `status`) VALUES ('$industry_id','$status')";
    ...
    foreach($product_images as $key=>$value){
        ...
        $file_destination = '../uploads/industry_photo_gallery/' . $product_images1;
    ...
    if( $result1 == 1){
    echo "<script type='text/javascript'>window.location='industry_case_studies.php?msg=success'</script>";
    } else {
       echo "<script type='text/javascript'>window.location='industry_case_studies.php?msg=fail'</script>";
    }
}
?>
