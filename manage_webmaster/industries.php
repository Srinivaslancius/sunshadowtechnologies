...
<?php $getIndustriesData = getAllDataWithActiveRecent('industries'); $i=1; ?>
      <div class="site-content">
        <div class="panel panel-default panel-table">
          <div class="panel-heading">
            <a href="add_industries.php" style="float:right">Add Industries</a>
            <h3 class="m-t-0 m-b-5">Industries</h3>
          </div>
                        ...
                        <div class="modal-content animated flipInX">
                          ...
                          <div class="modal-body" id="modal_body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6"><img src="<?php echo $base_url . 'uploads/industries_images/'.$row['image'] ?>" height="100" width="100"/></div>
                            </div>
                          </div>
