...
<?php $getOurTeamData = getAllDataWithActiveRecent('our_team'); $i=1; ?>
     <div class="site-content">
        <div class="panel panel-default panel-table">
          <div class="panel-heading">
            <a href="add_banners.php" style="float:right">Add Our Team</a>
          ...
          <div class="panel-body">
            <div class="table-responsive">
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  <?php while ($row = $getOurTeamData->fetch_assoc()) { ?>
                  <tr>
                     <td><?php echo $i;?></td>
                    <td><?php echo $row['title'];?></td>
                    <td><img src="<?php echo $base_url . 'uploads/our_team_images/'.$row['image'] ?>" height="100" width="100"/></td>
