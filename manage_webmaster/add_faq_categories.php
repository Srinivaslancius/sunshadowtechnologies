...
if (!isset($_POST['submit']))  {
  ...
  $status = $_POST['status'];  
  $sql = "INSERT INTO faq_categories (`faq_category`, `status`) VALUES ('$faq_category', '$status')";
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="form-control-2" name="faq_category" placeholder="Category Name" data-error="Please enter Category Name." required>
