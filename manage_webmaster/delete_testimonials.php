...
if(isset($result)) {
   echo "<script>alert('Our Team Data Deleted Successfully');window.location.href='testimonials.php';</script>";
} else {
   echo "<script>alert('Our Team Data Not Deleted');window.location.href='testimonials.php';</script>";
}
?>